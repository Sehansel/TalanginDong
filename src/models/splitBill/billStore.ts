...
export const BillStoreModel = types
  .model('BillStore')
  .props({
...
export interface BillStore extends Instance<typeof BillStoreModel> {}
export interface BillSnapshot extends SnapshotOut<typeof BillStoreModel> {}
